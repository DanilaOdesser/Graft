      ...
      <div className="w-full max-w-sm animate-in">
        ...
        <div className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-2xl shadow-sm overflow-hidden">
          <div className="px-6 pt-6 pb-4 border-b border-[var(--color-border)]">
            <h1 className="font-[family-name:var(--font-display)] font-bold text-lg text-[var(--color-text)]">Sign in</h1>
            <p className="text-[13px] text-[var(--color-text-faint)] mt-0.5">Welcome back to your workspace</p>
          </div>
        ...
        <p className="text-center text-[13px] text-[var(--color-text-faint)] mt-5">
          ...
          <Link to="/register" className="text-[var(--color-blue)] hover:underline font-medium">
            Create one
          </Link>
        </p>
      </div>
